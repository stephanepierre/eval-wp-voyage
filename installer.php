...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'monagencedevoyage_0eb8059a2fe380ba9930_20210624073424_archive.zip';
	const ARCHIVE_SIZE		 = '46162602';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0eb8059-24073424';
    const SECONDARY_PACKAGE_HASH = '59e59ce-24073424';
	const VERSION			 = '1.4.1';
